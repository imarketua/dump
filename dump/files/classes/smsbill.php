 ...
 *
 * useLang - значения 'ru','ua','en','lt','az','es'. Значений может быть больше.
 * Позволяет выбарть язык формы по умолчанию. Если не указывать значение, то форма будет показана на русском языке.
 * $smsbill->useLang('ua');
 * 
